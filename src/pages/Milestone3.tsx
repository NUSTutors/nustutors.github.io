...
export default function Milestone3() {
  ...
  return (
    <div>
      <p className={"px-8 pt-8 text-left"}>This is our Milestone 3 page!</p>
      ...
      <div className={"aspect-[1/1.38] w-full max-w-5xl px-8 pb-0 pt-4"}>
        {usePNG ? (
          <img src="/ms3/5732.png" alt="Liftoff Poster" />
        ) : (
          <img src="/ms3/5732.svg" alt="Liftoff Poster" />
        )}
      </div>
      ...
      <div className={"aspect-video w-full max-w-5xl px-8 py-4"}>
        <video controls width="100%">
          <source src="/ms3/5732.mp4" type="video/mp4" />
          <track
            label="English"
            kind="subtitles"
            srcLang="en"
